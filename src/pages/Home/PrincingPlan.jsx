  ...
  return (
    <>
      ...
      <div className='w-full h-auto flex justify-center gap-x-5 gap-y-8 flex-wrap' >
        {/*Frontend*/}
    <div className='lg:w-[25%] md:w-full sm:w-full w-full h-auto px-10 lg:py-12 md:py-12 sm:py-10 py-10 bg-black/10 rounded-lg border-[6px] border-green-600/30 hover:border-green-600 hover:bg-gray-600/10 ease-out duration-700 cursor-pointer'>
